...
assert.strictEqual(hub.getSheetByName('ExternalMarkets').getLastRow(), 1, 'Hub mappings are queued through the External Results Hub bridge and do not block the local build');
