...
assert(app.includes('APP_ROUTE_HOTFIX_VERSION = "v1230-reality-tv-hub-complete-mirror"'), 'v1.2.1 cache version is missing');
assert(html.includes('hotfix=v1230-reality-tv-hub-complete-mirror'), 'App shell must load the v1.2.1 cache version');
