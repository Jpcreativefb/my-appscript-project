...
assert(app.includes('APP_ROUTE_HOTFIX_VERSION = "v1250-historical-reality-results"'), 'v1.2.1 cache version is missing');
assert(html.includes('hotfix=v1250-historical-reality-results'), 'App shell must load the v1.2.1 cache version');
