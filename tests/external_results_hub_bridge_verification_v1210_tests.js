...
assert(app.includes('APP_ROUTE_HOTFIX_VERSION = "v1240-durable-reality-approval"'), 'v1.2.1 cache version is missing');
assert(html.includes('hotfix=v1240-durable-reality-approval'), 'App shell must load the v1.2.1 cache version');
