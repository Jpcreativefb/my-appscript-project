...
assert(appJs.includes('APP_ROUTE_HOTFIX_VERSION = \"v1116-reality-tv-approval-progress\"'), "Route hotfix version must force fresh admin modules");
assert(fs.readFileSync(path.join(root, 'frontend/app.html'), 'utf8').includes('hotfix=v1116-reality-tv-approval-progress'), "App shell must force a fresh app.js request");
