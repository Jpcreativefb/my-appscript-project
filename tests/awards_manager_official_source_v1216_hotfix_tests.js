...
assert(app.includes('321-awards-official-source-v1216'), 'Main frontend asset marker missing.');
assert(appMirror.includes('321-awards-official-source-v1216'), 'Frontend mirror asset marker missing.');
assert(html.includes('321-awards-official-source-v1216'), 'HTML asset marker missing.');
assert(sw.includes('awards-app-v321-awards-official-source-v1216'), 'Service-worker cache marker missing.');
