...
assert(app.includes('324-awards-mobile-workflow-v1216'), 'v323 Awards batch-builder asset marker missing.');
assert(sw.includes('awards-app-v324-awards-mobile-workflow-v1216'), 'v323 Awards batch-builder service-worker cache missing.');
