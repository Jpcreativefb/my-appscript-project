...
assert(adminAwards.includes('1. Game & Source Setup'), 'Section 1 game/source setup missing.');
assert(adminAwards.includes('Official Website URL (preferred result source)'), 'Official Website must be in Section 1.');
assert(adminAwards.includes('Display Market Probabilities'), 'Game-level probability display control missing.');
...
assert(adminAwards.includes('Number of Changes') && adminAwards.includes('Unlimited until lock'), 'Number-of-changes control missing.');
...
assert(adminAwards.includes('Market / Answer Grid') && adminAwards.includes('Show Odds') && adminAwards.includes('Include All'), 'Market-grid popup controls missing.');
...
assert(app.includes('323-awards-batch-builder-v1216'), 'v323 Awards batch-builder asset marker missing.');
assert(sw.includes('awards-app-v323-awards-batch-builder-v1216'), 'v323 Awards batch-builder service-worker cache missing.');
