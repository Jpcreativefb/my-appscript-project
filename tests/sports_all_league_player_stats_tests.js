...
assert(sportsHtml.includes('sports.js?v=240-all-league-player-stats'), 'Sports page cache buster missing');
assert(serviceWorker.includes('awards-app-v240-all-league-player-stats'), 'Service worker cache version missing');
