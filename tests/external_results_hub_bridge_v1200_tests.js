...
assert(app.includes('APP_ROUTE_HOTFIX_VERSION = "v1230-reality-tv-hub-complete-mirror"'), 'Hub bridge cache version is missing');
assert.strictEqual(app, appCompat, 'Both app loader copies must match');
assert(html.includes('hotfix=v1230-reality-tv-hub-complete-mirror'), 'App shell must request the Hub bridge cache version');
