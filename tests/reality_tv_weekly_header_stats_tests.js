...
assert(html.includes('307-reality-tv-survivor-comparison'), 'Frontend cache version was not bumped.');
assert(sw.includes('v307-reality-tv-survivor-comparison'), 'Service worker cache version was not bumped.');
