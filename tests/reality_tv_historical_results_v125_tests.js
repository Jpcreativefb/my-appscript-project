...
assert(app.includes('310-reality-tv-historical-results'), 'App asset cache version not bumped.');
assert(html.includes('310-reality-tv-historical-results'), 'HTML asset cache version not bumped.');
assert(sw.includes('v310-reality-tv-historical-results'), 'Service worker cache version not bumped.');
