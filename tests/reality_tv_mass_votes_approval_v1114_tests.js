...
assert(app.includes('APP_ROUTE_HOTFIX_VERSION = "v1115-reality-tv-approval-episode-plan"'), "New frontend modules should bypass cached v1.1.13 scripts");
assert(html.includes("hotfix=v1115-reality-tv-approval-episode-plan"), "App shell should request the v1.1.14 route hotfix");
