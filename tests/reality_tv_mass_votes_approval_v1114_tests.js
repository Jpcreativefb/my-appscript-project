...
assert(app.includes('APP_ROUTE_HOTFIX_VERSION = "v1116-reality-tv-approval-progress"'), "New frontend modules should bypass cached v1.1.13 scripts");
assert(html.includes("hotfix=v1116-reality-tv-approval-progress"), "App shell should request the v1.1.14 route hotfix");
