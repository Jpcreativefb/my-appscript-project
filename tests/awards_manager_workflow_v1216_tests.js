...
assert(adminAwards.includes('Load Selected Events & Questions') && adminAwards.includes('Build All Loaded Questions'), 'Awards Manager must include staged multi-event batch workflow.');
...
assert(adminAwards.includes('Number of Changes') && adminAwards.includes('Unlimited until lock'), 'Awards Manager pick-change control missing.');
assert(adminAwards.includes('Question Play Type') && adminAwards.includes('Question Display'), 'Awards Manager play/display controls missing.');
...
assert(app.includes('323-awards-batch-builder-v1216'), 'Current Awards workflow asset marker missing.');
assert(sw.includes('awards-app-v323-awards-batch-builder-v1216'), 'Current service-worker cache marker missing.');
