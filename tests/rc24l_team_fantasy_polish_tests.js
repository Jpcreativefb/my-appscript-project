...
assert(html.includes('name="pattc-ui-hotfix" content="v1219rc24l-team-fantasy-polish-r1"') || html.includes('name="pattc-ui-hotfix" content="v1219rc24m-team-fantasy-layout-r1"'));
assert(html.includes("rc24l-team-fantasy-polish.css"));
assert(app.includes("rc24l-team-fantasy-polish-r1") || app.includes("rc24m-team-fantasy-layout-r1"));
