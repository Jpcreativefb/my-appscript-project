...
const newMarker = 'if (name === "notifications") url.searchParams.set("module", "v1218i-notification-test-lab");';
const oldMarkers = [
...
if (a !== b) throw new Error("frontend app mirrors are not synchronized after v1.2.18i patch");

console.log("v1.2.18i notification route cache-buster applied.");
