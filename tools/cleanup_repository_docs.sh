...
for file in *.md *.txt; do
  [[ -e "$file" ]] || continue
  case "$file" in
    API_CONTRACT.md|DEPLOYMENT_CHECKLIST.md|PROJECT_STRUCTURE.md|CHANGELOG.md|PRODUCTION_STATUS.md|PRODUCTION_HARDENING_V1_2_16.md|PRODUCTION_SMOKE_TEST_V1_2_16.md|CHANGED_FILES_V1_2_16.txt)
      ;;
    README_*.md)
